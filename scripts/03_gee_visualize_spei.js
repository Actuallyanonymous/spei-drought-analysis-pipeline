...
state_name = 'Madhya Pradesh' # You can change this to 'Andhra Pradesh'
...
# --- 4. The Export Function (Corrected for maxPixels Error) ---
...
def submit_export(year, month):
    ...
    p_minus_pet = P.subtract(PET_resampled_mean).rename('P_minus_PET').clip(aoi).set({'system:time_start': start_date.millis()})
